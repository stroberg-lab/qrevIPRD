...
do
    ...
    python calc_assoc_prob.py -nL $N_L -nC $N_C -rd "${RUNDIR}/" -tf $TRAJFILE -sf $SAVEFILE
...
# Zip .npy output files into combinded zip file (same as .npz format)
zip $BASEDIR/unbound_output_combined.zip $OUTDIR/*.npy
