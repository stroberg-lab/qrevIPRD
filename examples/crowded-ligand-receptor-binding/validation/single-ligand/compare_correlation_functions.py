...
if __name__=="__main__":
    ...
    basedir_q = "./db_quasi_reversible_sims/long_sims/boxsize_5_5_5/run_bulk_nL{}_nC{}/trajectory_{}".format(nL,nC,traj_number)
    ...
    for (sdi,lsdi,kai,color) in zip(surv_data,logsurv_data,kao_r,colors):
        ...
        axU[1].plot(lsdi[:,0]+0.5*lsdi[:,1],lsdi[:,2],'-.',label="$k_{{a}}^{{o}}={}$".format(kai))
