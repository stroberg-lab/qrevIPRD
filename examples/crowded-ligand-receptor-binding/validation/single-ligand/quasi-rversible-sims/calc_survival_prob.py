...
if __name__=="__main__":
    ...
    #kao = [1.0e+0,1.0e+1,1.0e+2,1.0e+3,1.0e+4]
    kao = np.logspace(0.,4.,5)
    kdo = 1.0e-0
    ...
    for i in range(len(kao)):
        for j in range(len(nCs)):
            ...
            out['kao'] = kao[i]
            out['kdo'] = kdo
            outfilename = "./analyzed_data/analysis_out_nC_{}_kao_{}_kdo_{}_targetprob_{}_nsteps_{}_ntraj_{}.npz".format(nCs[j],kao[i],kdo,target_surv_prob,nsteps,ntraj)
