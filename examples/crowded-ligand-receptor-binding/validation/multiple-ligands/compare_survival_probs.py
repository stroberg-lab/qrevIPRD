...
if __name__=="__main__":
    ...
    #basedir_qr = "./db_quasi_reversible_sims/test_low_memory"
    #basedir_qr = "./db_quasi_reversible_sims/module_weights_L05_S05"
    ...
    #kao_qr = np.logspace(0,4,20)	# additional values for plotting
